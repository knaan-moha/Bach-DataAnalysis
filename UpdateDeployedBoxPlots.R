library(readxl)
react_performance_final <-react_Update_Userflow_Deployed <- read_excel("BachelorDocumantion /UserFlowDataSets /react_Update_Userflow_Deployed.xlsx")
blazor_performance_final <- blazor_Update_Userflow_Deployed <- read_excel("BachelorDocumantion /UserFlowDataSets /blazor_Update_Userflow_Deployed.xlsx")
