library(readxl)
react_performance_final <- read_excel("BachelorDocumantion /DataSets /react_PageLoad_NonDep_per_final.xlsx")
blazor_performance_final <- read_excel("BachelorDocumantion /DataSets /blazor_pageLoad_NonDep_per_final.xlsx")
